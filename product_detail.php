...
<head>
    ...
    <style>
        ...
        .btn-main { padding: 15px 40px; background: #1a4d2e; color: white; border: none; border-radius: 30px; font-weight: bold; font-size: 16px; cursor: pointer; transition: 0.3s; display: flex; align-items: center; gap: 10px; width: 100%; justify-content: center;}
...
<div class="product-container">
    <?php if ($product): ?>
        ...
        <div class="product-info">
            ...
            <a href="seller_profile.php?id=<?php echo $product['seller_id']; ?>" class="seller-card">
                ...
                <div style="text-align:right;">
                    <span style="background:#f3f4f6; padding:4px 8px; border-radius:4px; font-size:11px; font-weight:bold; color:#1a4d2e;"><?php echo isset($text['seller_profile']) ? $text['seller_profile'] : 'View'; ?> &rarr;</span>
                </div>
            </a>
            ...
            <div class="action-buttons">
                <!-- IMPORTANT CHANGE: Form Action Logic -->
                <?php if (isset($_SESSION['user_id'])): ?>
                    <!-- LOGGED IN: Go to Cart Action -->
                ...
                <?php else: ?>
                    ...
                    <form action="login.php" method="GET" style="flex: 1;">
                        <button type="submit" class="btn-main" onclick="alert('Please login to start shopping!');">
        ...
        <div class="reviews-container">
            ...
            <p style="color: #666; font-style: italic;">Verified reviews coming soon.</p>
        </div>
